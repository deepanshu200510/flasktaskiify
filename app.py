...
@login_required
def home():
    print("Session permanent status:", session.permanent)  # Debug statement
    print("User ID in session:", session.get("user_id"))  # Debug statement
...
def login_page():
    ...
    if form.validate_on_submit():
        ...
        if attempted_user:
            print(f"User found: {attempted_user.username}")  # Debug statement
            if attempted_user.check_password_correction(form.password.data):
                print("Password is correct! Logging in...")  # Debug statement
                ...
                print("Session marked as permanent:", session.permanent)  # Debug statement
                flash(f'Success! You are logged in as: {attempted_user.username}', category='success')
                return redirect(url_for('home'))
            else:
                print("Password is incorrect!")  # Debug statement
        ...
        for field, errors in form.errors.items():
            for error in errors:
                print(f"Error in {field}: {error}")  # Debug statement
